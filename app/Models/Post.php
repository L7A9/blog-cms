...
{
    use HasFactory;
    protected $fillable = ['title', 'content', 'article', 'category_id', 'user_id', 'slug', 'status'];
    ...
    public static function boot()
    {
        ...
        static::updating(function ($post) {
            if ($post->isDirty('article') && !is_null($post->getRawOriginal('artocle'))) {
                Storage::delete($post->getRawOriginal('article'));
            }
        });
        static::deleting(function ($post) {
            if (!is_null($post->getRawOriginal('article'))) {
                Storage::delete($post->getRawOriginal('article'));
            }
        });
    }
